...
(**
 * Floyd-Warshall Shortest Path Semantics (CLRS Theorem 25.2)
 *
 * Proves that fw_outer computes actual shortest path distances by:
 * 1. Defining fw_entry — the FW recurrence d^(k)[i][j]
 * 2. Proving fw_inner_j/fw_inner_i/fw_outer compute fw_entry
 * 3. Defining restricted-intermediate shortest paths
 * 4. Connecting fw_entry to true shortest-path distances
 *
...
(* ========================================================================
   § 1. FW Recurrence — d^(k)[i][j] (CLRS Equation 25.2)
   ======================================================================== *)
...
(* ========================================================================
   § 2. Inner Loop Lemmas — fw_inner_j properties
   ======================================================================== *)
