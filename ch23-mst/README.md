...
| `CLRS.Ch23.Prim.Impl.fsti` | Pulse | Imperative Prim interface: prim fn sig |
...
| Module | Status |
|--------|--------|
| MST.Spec (.fst + .fsti) | ✅ Fully proven (cut property, MST existence) |
| Kruskal.Spec (.fst + .fsti) | ✅ Fully proven |
| Kruskal.Components / EdgeSorting / SortedEdges | ✅ Fully proven |
...
| Prim.Complexity (.fst + .fsti) | ⚠️ Verified but disconnected from Prim.Impl |
| MST.Complexity (.fst + .fsti) | ✅ |
