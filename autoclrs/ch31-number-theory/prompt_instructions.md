Review the code in ch31. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch31 that extracts the
...
edit files in ch31 and commit only files in this ch31. Commit only
