Review the code in ch22. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch22 that extracts the
...
edit files in ch22 and commit only files in this ch22. Commit only
