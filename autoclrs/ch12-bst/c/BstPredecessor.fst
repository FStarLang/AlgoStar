  ...
  decreases (var_cap `SizeT.sub` var_i)
{
  ...
  return (func_bst_maximum_idx (!var_keys) (!var_valid) (!var_cap) (!var_right));
}

#restart-solver

fn rec func_walk_up_left
    (var_keys: (array Int32.t))
    (var_valid: (array Int32.t))
    (var_cap: SizeT.t)
    (var_i: SizeT.t)
  ...
  decreases var_i
{
  ...
  return (func_walk_up_left (!var_keys) (!var_valid) (!var_cap) (!var_parent));
}

#restart-solver

fn func_bst_predecessor
    (var_keys: (array Int32.t))
    (var_valid: (array Int32.t))
    (var_cap: SizeT.t)
    (var_idx: SizeT.t)
        ...
        (not ((id #int (Int32.v ((array_read var_valid return_1)))) = 0))))
{
  ...
  var_left := ((2sz `SizeT.mul` (!var_idx)) `SizeT.add` 1sz);
  if (((!var_left) `SizeT.lt` (!var_cap))) {
    if ((not (((array_read (!var_valid) (!var_left))) = (Int32.int_to_t 0)))) {
      return (func_bst_maximum_idx (!var_keys) (!var_valid) (!var_cap) (!var_left));
    } else {};
  } else {};
  return (func_walk_up_left (!var_keys) (!var_valid) (!var_cap) (!var_idx));
}