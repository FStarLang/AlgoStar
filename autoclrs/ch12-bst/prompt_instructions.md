Review the code in ch12. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch12 that extracts the
...
edit files in ch12 and commit only files in this ch12. Commit only
