Review the code in ch10. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch10 that extracts the
...
edit files in ch10 and commit only files in this ch10. Commit only
