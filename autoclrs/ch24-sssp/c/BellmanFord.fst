    ...
    invariant (with_pure
        (forall
          ...
          ((var_k `SizeT.lt` ((!var_n) `SizeT.mul` (!var_n))) ==>
            (((op_Minus 1000000) <= (id #int (Int32.v ((array_read (!var_weights) var_k))))) &&
...
fn func_bellman_ford_check_vertex
    (var_weights: (array Int32.t))
    (var_dist: (array Int32.t))
    (var_n: SizeT.t)
    (var_source: SizeT.t)
...
fn rec func_bellman_ford_check_all
    (var_weights: (array Int32.t))
    (var_dist: (array Int32.t))
    (var_n: SizeT.t)
    (var_source: SizeT.t)
  ...
  decreases (var_n `SizeT.sub` var_bound)
{
  ...
  var_r := (!var_result_in);
  (func_bellman_ford_check_vertex
      (!var_weights)
      (!var_dist)
      (!var_n)
      (!var_source)
                          ...
                          ((var_u `SizeT.mul` var_n) `SizeT.add` var_v))))))))))))
{
  ...
  let mut var_dist = var_dist;
  let mut var_result = var_result;
  (func_bellman_ford_relax (!var_weights) (!var_n) (!var_source) (!var_dist));
  (!var_result) :=
    (func_bellman_ford_check_all
      (!var_weights)
      (!var_dist)
