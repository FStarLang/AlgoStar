Review the code in ch24. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch24 that extracts the
...
edit files in ch24 and commit only files in this ch24. Commit only
