(**
 * CLRS Chapter 13: Red-Black Trees — Correctness Lemmas
 *
 * Proofs of correctness properties for the operations defined in
 * CLRS.Ch13.RBTree.Spec:
 *
 *   - CLRS Theorem 13.1: height ≤ 2·lg(n+1)
 *   - Insert correctness: membership, BST, RB invariant preservation
 *   - Delete correctness: membership, BST, RB invariant preservation
 *   - Minimum/maximum: membership and optimality
 *   - Successor/predecessor: correctness
 *   - Node count preservation for insert
 *
