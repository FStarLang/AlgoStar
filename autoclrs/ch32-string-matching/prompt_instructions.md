Review the code in ch32. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch32 that extracts the
...
edit files in ch32 and commit only files in this ch32. Commit only
