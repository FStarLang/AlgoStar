Review the code in ch25. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch25 that extracts the
...
edit files in ch25 and commit only files in this ch25. Commit only
