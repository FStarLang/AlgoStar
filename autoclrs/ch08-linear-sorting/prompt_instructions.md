Review the code in ch08. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch08 that extracts the
...
edit files in ch08 and commit only files in this ch08. Commit only
