Review the code in ch16. I want to compile the ImplTest.fst file and all
...
Add an extract and test target to the Makefile in ch16 that extracts the
...
edit files in ch16 and commit only files in this ch16. Commit only
