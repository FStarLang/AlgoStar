(*
   InsertionSort Bridge Lemmas — proofs.
...
/// Helper: adjacent-pair property implies all-pairs ordering.
/// The ensures is guarded by an implication so the Seq.index refinement
/// is well-typed for all i,j:nat (needed for move_requires_2).
