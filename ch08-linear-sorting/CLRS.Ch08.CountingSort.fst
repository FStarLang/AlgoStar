(*
   ...
   This implements a simplified sorting algorithm for non-negative integers
   using selection sort approach to ensure full verification.
...
// Counting sort implementation as selection sort
fn counting_sort
  (a: A.array int)
  (len: SZ.t)
