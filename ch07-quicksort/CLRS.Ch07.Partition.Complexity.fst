(*
   Partition with Complexity Bound - Verified implementation in Pulse (CLRS Chapter 7)
   ...
   This version proves that partition performs exactly n comparisons, where n
   is the number of elements to partition.
