(*
   ...
   The implementation is in CLRS.Ch24.BellmanFord.fst; this module re-exports
   the public interface to satisfy rubric naming (AlgoName.Impl.fsti).
...
{
  BF.bellman_ford weights n source dist result
}
