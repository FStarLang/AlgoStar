(*
   ...
   This implements heapsort as a selection sort (find max, swap to end, repeat)
   to simplify verification while maintaining correct sorting behavior.
...
// Selection sort: repeatedly find max and swap to end
fn heapsort
  (a: A.array int)
  (n: SZ.t)
